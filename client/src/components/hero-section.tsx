      ...
      try {
        ...
        if (plansResponse.ok) {
          ...
          if (plansData.success && Array.isArray(plansData.data)) {
            const proPlan = plansData.data.find(
              (plan: any) => plan.name === 'Pro'
            );
            if (proPlan) {
    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="space-y-6 mb-8">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-lg text-gray-700">
                Tracks posture, movement and blink rate via webcam
              </span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-6 h-6 bg-secondary rounded-full flex items-center justify-center">
              ...
              <span className="text-lg text-gray-700">
                Auto-detects bad screen habits as they happen
              </span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-6 h-6 bg-secondary rounded-full flex items-center justify-center">
              ...
              <span className="text-lg text-gray-700">
                Conditions better habits via smart reminders
              </span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-6 h-6 bg-secondary rounded-full flex items-center justify-center">
        ...
        <div className="relative">
          ...
          <div
            className="absolute -top-4 -right-4 glass rounded-2xl w-16 h-16 flex items-center justify-center animate-float"
          ...
          <div
            className="absolute -bottom-4 -left-4 glass rounded-2xl w-16 h-16 flex items-center justify-center animate-float"
