        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing and using desk.ai ("the Service"), you accept and
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              desk.ai is a screen habit tracking application designed to help
              users monitor and improve their digital wellness. The service
              includes:
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              The Service is operated by: Guenther & Schwarz GbR, trading as
              desk.ai ("we", "us", or "our").
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              We collect and process data to provide our services, including
              screen time data, usage patterns, and device information. This
              data is used solely for the purpose of providing and improving our
              service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              are owned by desk.ai and are protected by international copyright,
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Federal Republic of Germany, without regard to its conflict of law
