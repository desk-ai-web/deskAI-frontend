...
import PostureDemo from '@/assets/posture_demo.svg';
import MoveBreakDemo from '@/assets/move_break_demo.svg';
import TwentyTwentyTwentyDemo from '@/assets/20-20-20_demo.svg';
import ScreenDistanceDemo from '@/assets/screen_distance_demo.svg';
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-12">
          ...
          <section>
            ...
            <div className="relative">
              <img
                src={PostureDemo}
                alt="Posture demonstration"
                className="hidden md:block float-right ml-6 mb-4 w-64 h-auto invert dark:invert-0"
              />
              <img
                src={PostureDemo}
                alt="Posture demonstration"
                className="md:hidden w-full mb-6 mx-auto invert dark:invert-0"
              />
              <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  ...
                  . To prevent this, research emphasizes maintaining a neutral
                  spine – shoulders relaxed, core engaged, and head aligned{' '}
                  {renderCitations('[1, 3]')}.
                </p>
                <p>
                  While it is easy to sit straight for a moment, we often fall
                  back into old patterns as soon as our attention shifts. The
                  desk.ai app helps you become aware of posture issues during
                  your screen work. Our <b>Hunch Detection</b> feature detects
                  the classic slouched neck from your webcam and subtly notifies
                  you to sit upright. In this way, the app reinforces a
                  healthier posture until it sticks.
                </p>
              </div>
          ...
          <section>
            ...
            <div className="relative">
              <img
                src={MoveBreakDemo}
                alt="Move break demonstration"
                className="hidden md:block float-left mr-6 mb-4 w-32 h-auto invert dark:invert-0"
              />
              <img
                src={MoveBreakDemo}
                alt="Move break demonstration"
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  A good posture puts less strain on your neck and back than a
                  bad one, however, staying in any position for too long raises
                  health risks. That means, even with a good posture, staying
                  motionless strains muscles and joints and sitting for
                  prolonged time is associated with cardiovascular problems and
                  even cancer {renderCitations('[4, 5]')}. Experts commonly
                  advise to interchange sitting intervals with standing,
                  stretching or brief walks every 20-60 minutes{' '}
                  {renderCitations('[2, 6]')}.
                </p>
                <p>
                  That is why the desk.ai has developed the <b>Move Break</b>{' '}
                  feature that alerts you if you have remained stationary for
                  too long. This is your quick reminder to move if you have not
                  in the past 20-60 minutes to keep your muscles relaxed and
                  your joints limber.
                </p>
              </div>
              <div className="clear-both"></div>
          ...
          <section>
            ...
            <div className="relative">
              <img
                src={TwentyTwentyTwentyDemo}
                alt="20-20-20 rule demonstration"
                className="hidden md:block float-right ml-6 mb-4 w-64 h-auto invert dark:invert-0"
              />
              <img
                src={TwentyTwentyTwentyDemo}
          ...
          <section>
            ...
            <div className="relative">
              <img
                src={ScreenDistanceDemo}
                alt="Screen distance demonstration"
                className="hidden md:block float-left mr-6 mb-4 w-64 h-auto invert dark:invert-0"
              />
              <img
                src={ScreenDistanceDemo}
                alt="Screen distance demonstration"
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  ...
                  your posture. Ergonomics experts recommend placing your
                  monitor at about 20-30'' (50-75 cm). This distance typically
                  allows text to be read without squinting and avoids leaning.
                  If the screen is too close, your eyes have to work harder to
                  focus, and you may also lean forward or tilt your neck, adding
                  stress to back and shoulder {renderCitations('[7, 11]')}.
                </p>
                <p>
                  Once you have found your comfortable screen distance, you can
                  use the <b>Screen Distance</b> feature to keep it. If you
                  (sub-consciously) lean forward, the app will alert you until
                  you are back in the comfortable distance.
                </p>
              </div>
              <div className="clear-both"></div>
            </div>
